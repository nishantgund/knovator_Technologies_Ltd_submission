...
//   }
//
//   // Fetch posts from API and update Hive only if changed
//   Future<void> fetchPosts() async {
//     try {
//       final String endpoint = 'https://dummyjson.com/posts?limit=100';
...
//
//         // Compare with existing Hive data
//         bool isChanged = false;
//         if (apiPosts.length != postBox.length) {
//           isChanged = true;
//         } else {
//           for (var post in apiPosts) {
//             final storedPost = postBox.get(post.id);
//             if (storedPost == null ||
//                 storedPost.title != post.title ||
//                 storedPost.body != post.body) {
//               isChanged = true;
//               break;
//             }
//           }
//         }
//
//         // If data changed, update Hive and UI
//         if (isChanged) {
//           await postBox.clear();
